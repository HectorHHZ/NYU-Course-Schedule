...
- If you want to talk to use directly, you can contact via email: hh2537@nyu.edu / sz3719@nyu.edu.

# Algorithm / Mathematics 

|                            Course                            |    Instructor     |     Status      |        Workload         |                          Repository                          |                        Brief Comment                         |
| :----------------------------------------------------------: | :---------------: | :-------------: | :---------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|      Data Structure and Algorithm (Tandon Engineering)       | Liu Yong/ Pei Liu | complete(2021F) | 12 HW + midterm + final |           [Link](https://github.com/HectorHHZ/DSA)           | Important couse for software development. Grades mainly based on midterm and final exams. |
...
|          Applied Matrix Theory (Tandon Engineering)          | Zhong-Ping Jiang  |                 |                         |                                                              |          Relative small workload. Take-home exams.           |
...
|                      Course                       | Instructor  |     Status      |             Workload              |                          Repository                          |                        Brief Comment                         |
| :-----------------------------------------------: | :---------: | :-------------: | :-------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|       Embedded System (Tandon Engineering)        |   Campisi   | complete(2021F) | 10 homework + 2 midterms +  final | [Link](https://github.com/HectorHHZ/RealTime_EmbeddedSystem) | Relative small workload, quiz questions will be greatly based on the homework and recitation class. Easier if you have MIPS/RISC-V foundation. |
...
|                            Course                            |          Instructor          |                            Status                            |           Workload           |                     Repository/ Website                      |                           comment                            |
| :----------------------------------------------------------: | :--------------------------: | :----------------------------------------------------------: | :--------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|    Introduction to Machine Learning (Tandon Engineering)     |       Anna Choromanska       |                       complete(2021F)                        | 5 homework + midterm + final |       [Link](https://github.com/HectorHHZ/Intro-to-ML)       | Exam questions mainly based on homework. MATLAB programming questions in the homework but not in the exam. Math foundation needed. |
...
|              Deep Learning (Tandon Engineering)              |        Chinmay Hegde         |                                                              |                              | [Link](https://chinmayhegde.github.io/dl-notes/) [Link for MP1](https://github.com/HectorHHZ/DeepLearning_MiniProject1) [Link for MP2](https://github.com/HectorHHZ/MiniProject2_3) |                            ✨✨✨✨✨                             |
...
|                            Course                            | Instructor | Status |        Workload         | Repository |                           comment                            |
| :----------------------------------------------------------: | :--------: | :----: | :---------------------: | :--------: | :----------------------------------------------------------: |
| Programming for Business Analytics (Tandon Engineering in MOT MGGY 8401)(1.5 creditc) |            |        | 7 homework + 1 projects |            | Entry level python course and 1.5 credits. Useful if you want to fulfill the credit requirements and the course workload is small. |
